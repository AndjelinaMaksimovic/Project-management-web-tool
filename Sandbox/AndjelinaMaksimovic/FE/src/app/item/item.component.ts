...
@Component({
    ...
    template: `
        <div class="main-container center-container flex-row">
            <div>
                <p style="text-align: left; margin: 20px;">{{shortDescription}}</p>
                <p style="text-align: left; margin: 20px;"><b>{{assignedTo}}</b></p>
            </div>            
            <div style="min-width: 200px; margin-top: auto; margin-bottom: auto;">
                ...
                <i (click)="this.removeClick.emit();" class="fa-regular fa-trash-can" style="margin: 20px; color: blue;"></i>
            </div>
        </div>
    `,
