...
export class GanttTestComponent{
  items = [
    ...
    new Item(2, "Item 2", "desc 2", "category 1", "Low", "status 3", Date.now() + TimeScale.day*2, Date.now() + TimeScale.day * 3, [{firstName: 'Milan', lastName: 'Milanovic', id: 1, profilePicture: ''}, {firstName: 'Ivan', lastName: 'Ivanovic', id: 2, profilePicture: ''}], [3], 100, ItemType.task, '#1ab99c'),
