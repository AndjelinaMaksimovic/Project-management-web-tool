...
export class GanttTestComponent{
  items = [
    ...
    new Item(4, 4, 3, 1, "Milestone", "desc 4", "category 1", "Low", "status 1", Date.now(), Date.now(), [{firstName: 'Ivan', lastName: 'Ivanovic', id: 1, profilePicture: ''}], [], 50, ItemType.milestone, '#c24e4e'),
    new Item(5, 3, 4, 1, "Item 4", "desc 4", "category 1", "Low", "status 1", Date.now(), Date.now() + TimeScale.day * 10, [{firstName: 'Milan', lastName: 'Milanovic', id: 1, profilePicture: ''}], [], 50, ItemType.task, '#c24e4e'),
  ]
  // items: Item[] = []
  // constructor(){
  //   const limit = 300
