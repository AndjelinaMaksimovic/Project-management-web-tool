...
export class GanttTestComponent{
  items = [
    new Item(1, "Item 1 overflow overflow overflow overflow", "desc", "category 1", "Low", "status 1", Date.now() - TimeScale.day, Date.now(), [{firstName: 'Milan', lastName: 'Milanovic', id: 1, profilePicture: ''}], [2], 100, ItemType.task, '#5096A4'),
    new Item(2, "Item 2", "desc 2", "category 1", "Low", "status 3", Date.now() + TimeScale.day*2, Date.now() + TimeScale.day * 30, [{firstName: 'Milan', lastName: 'Milanovic', id: 1, profilePicture: ''}, {firstName: 'Ivan', lastName: 'Ivanovic', id: 2, profilePicture: ''}], [3], 100, ItemType.task, '#1ab99c'),
    new Item(3, "Item 3", "desc 3", "category 2", "High", "status 3", Date.now() + TimeScale.day*4, Date.now() + TimeScale.day * 5, [], [], 20, ItemType.task, '#1ab99c'),
